...
This project is indexed by GitNexus as **nail-salon-pos** (1742 symbols, 4469 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/nail-salon-pos/context` | Codebase overview, check index freshness |
| `gitnexus://repo/nail-salon-pos/clusters` | All functional areas |
| `gitnexus://repo/nail-salon-pos/processes` | All execution flows |
| `gitnexus://repo/nail-salon-pos/process/{name}` | Step-by-step execution trace |
